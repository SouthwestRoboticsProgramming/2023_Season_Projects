...
public final class SchedulerOld {
    // Message names
    ...
    private static final SchedulerOld INSTANCE = new SchedulerOld();
    public static SchedulerOld get() {
        return INSTANCE;
    }
    ...
    private static abstract class ScheduleNode {
        ...
        public abstract void remove(SchedulerOld sch);
    }
    ...
    private static final class SubsystemNode extends ScheduleNode {
        ...
        @Override
        public void remove(SchedulerOld sch) {
