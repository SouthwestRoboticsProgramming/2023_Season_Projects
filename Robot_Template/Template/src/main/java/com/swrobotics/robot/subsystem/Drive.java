...
public class Drive implements Subsystem {
    ...
    public Drive(Input input) {
        ...
        SwerveModule w0 = SwerveModuleMaker.buildModule(this, 1, 1, 6, Angle.cwDeg(24.873 + 180), new Vec2d(-centerDistance, -centerDistance));
        SwerveModule w1 = SwerveModuleMaker.buildModule(this, 2, 2, 7, Angle.cwDeg(79.541 + 180), new Vec2d(-centerDistance, centerDistance));
        SwerveModule w2 = SwerveModuleMaker.buildModule(this, 3, 3, 8, Angle.cwDeg(132.188), new Vec2d(centerDistance, -centerDistance));
        SwerveModule w3 = SwerveModuleMaker.buildModule(this, 4, 4, 9, Angle.cwDeg(183.604), new Vec2d(centerDistance, centerDistance));
