...
public class ReindexCommand implements Command {
    private static final NTDouble RUN_TIME = new NTDouble("Thrower/Commands/Index/Reindex_Time_Seconds", 0.1);
    private static final NTDouble RUN_SPEED = new NTDouble("Thrower/Commands/Index/Reindex_Speed_Percent", 750);
    ...
    @Override
    public boolean run() {
        hopper.throwAtVelocity(Angle.ccwRot(RUN_SPEED.get()));
